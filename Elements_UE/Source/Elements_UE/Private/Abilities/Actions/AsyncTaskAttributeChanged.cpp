...
#include "Abilities/Actions/AsyncTaskAttributeChanged.h"
...
UAsyncTaskAttributeChanged* UAsyncTaskAttributeChanged::ListenForAttributeChange(UAbilitySystemComponent* AbilitySystemComponent, FGameplayAttribute Attribute)
{
	...
	if (!IsValid(AbilitySystemComponent) || !Attribute.IsValid())
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("UAsyncTaskAttributeChanged::ListenForAttributeChange called with invalid AbilitySystemComponent or Attribute"));
		return nullptr;
	}
...
UAsyncTaskAttributeChanged* UAsyncTaskAttributeChanged::ListenForAttributesChange(UAbilitySystemComponent* AbilitySystemComponent, TArray<FGameplayAttribute> Attributes)
{
	...
	{
		WaitForAttributeChangedTask->RemoveFromRoot();
		UE_LOG(LogTemp, Warning, TEXT("UAsyncTaskAttributeChanged::ListenForAttributesChange called with invalid AbilitySystemComponent or empty Attributes"));
		return nullptr;
	}
