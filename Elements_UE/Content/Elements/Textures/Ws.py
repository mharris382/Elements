...
reload(mm)
mat = mm.Material('Ws', True)
mat.clear()
TextureSample_Color = mat.add_node('TextureSample', -400, -176)
TextureSample_Color.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Textures/Ws_albedo.png', '/Game/Textures'))
...
TextureSample_ORM.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Textures/Ws_orm.png', '/Game/Textures'))
...
TextureSample_Normal.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Textures/Ws_normal.png', '/Game/Textures'))
...
TextureObject_0.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Textures/Ws_height.png', '/Game/Textures'))
