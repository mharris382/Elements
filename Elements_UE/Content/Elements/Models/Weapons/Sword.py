...
reload(mm)
mat = mm.Material('Sword', True)
mat.clear()
TextureSample_Color = mat.add_node('TextureSample', -400, -176)
TextureSample_Color.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Models/Weapons/Sword_albedo.png', '/Game/Textures'))
...
TextureSample_ORM.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Models/Weapons/Sword_orm.png', '/Game/Textures'))
...
TextureSample_Normal.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Models/Weapons/Sword_normal.png', '/Game/Textures'))
...
TextureObject_0.set_editor_property('texture', mm.import_texture('B:/UnrealEngine5_Projects/_repos4/Elements/Elements_UE/Content/Elements/Models/Weapons/Sword_height.png', '/Game/Textures'))
